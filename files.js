...
function newDriveFile(fileName, contentType, base64Data, callback = null) {
    ...
    var file = request.execute(callback || responseCallback);
    if (file) {
...
function readDriveFile(fileId, callback = null) {
...
function downloadDriveFile1(fileId, callback = null) {
    ...
    var requestExecuteResult = request.execute(function (response) {
...
function downloadDriveFile(fileId, callback = null) {
    callback = callback || responseCallback;
